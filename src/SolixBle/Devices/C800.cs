...
/// <summary>
/// C800(X) Power Station. Use this class to connect and monitor a C800(X)
/// power station. This model uses the same parameters and control logic as
/// the C1000(X) minus the expansion battery stuff. Also known as the A1755.
/// </summary>
public class C800 : SolixBleDevice, ISolixUpsDevice
{
    ...
    public C800(ulong bluetoothAddress, string? name = null) : base(bluetoothAddress, name)
    {
    }

    public C800(DiscoveredDevice device) : base(device)
    {
    }
