...
The C1000, C1000X, and C1000 Gen 2 are tested and working. The C300, C800, F2000, and F3800 should also work but I haven't personally tested them.
...
If you have a C1000 Gen 2 on Windows: there's a quirk where it drops the Bluetooth connection partway through setup, then reconnects. Anchor handles this automatically. You don't need to do anything.
